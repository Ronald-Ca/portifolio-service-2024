...
export default class CurriculumController {
    ...
    async create(req: Request, res: Response) {
        try {
            ...
            const response = await this._curriculumService.create({ curriculum: upload?.secure_url })
    ...
    async update(req: Request, res: Response) {
        try {
            ...
            const response = await this._curriculumService.update(id, { curriculum: upload?.secure_url })
