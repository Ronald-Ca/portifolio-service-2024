...
export default class ProjectController {
    ...
    async create(req: Request, res: Response) {
        try {
            const { name, description, link, stackIds } = createProject.parse(req.body)
    ...
    async update(req: Request, res: Response) {
        try {
            ...
            const { name, description, link, stackIds } = updateProject.parse(req.body)
